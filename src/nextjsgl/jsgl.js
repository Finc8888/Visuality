...
//%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
/**
 * @class Tspan element API class. It allows simple text Tspans to be drawn.
 * @extends jsgl.elements.AbstractElement
 * @constructor
 * @description Creates new instance of <code>jsgl.elements.TspanElement</code>.
 * @param {jsgl.elements.AbstractDomPresenter} domPresenter Appropriate DOM
 * presenter for rendering the Tspan element on the user's browser.
 * @param {jsgl.Panel} panel The factory <code>jsgl.Panel</code> object that
 * is creating the image. Note that no other object than <code>jsgl.Panel</code>
 * should call this constructor.
 * @since version 1.0
 * @version 2.0
 */
jsgl.elements.TspanElement=function(domPresenter, panel, x,y,text,zIndex) {

  jsgl.elements.AbstractElement.call(this, panel, zIndex);

  /**
   * Location of the anchor point of the Tspan.
   * @type jsgl.Vector2D
   * @private
   */
  this.location=new jsgl.Vector2D(x,y);
  ...
  /**
   * The string displayed by the Tspan.
   * @type string
   * @private
   */
  this.text=text || "";
  ...
  /**
   * The CSS font-family of the Tspan.
   * @type string
   * @private
   */
  this.fontFamily = "sans-serif";
  ...
  /**
   * The font size of the Tspan in pixels.
   * @type number
   * @private
   */
  this.fontSize = 12;
  ...
  /**
   * Determines whether or not the Tspan is underlined.
   * @type boolean
   * @private
   */
  this.underlined = false;
  ...
  /**
   * Determines whether or not the Tspan has a line above it or not.
   * @type boolean
   * @private
   */
  this.overlined = false;
  ...
  /**
   * Determines whether or not the Tspan is struck-through.
   * @type boolean
   * @private
   */
  this.struckThrough = false;
  ...
  /**
   * Determines whether the weight of the Tspan is bold or not.
   * @type boolean
   * @private
   */
  this.bold = false;
  ...
  /**
   * Determines whether the font style of the Tspan is italic or not.
   * @type boolean
   * @private
   */
  this.italic = false;
  ...
  /**
   * Horizontal anchor of the Tspan. It specifies the X-component of the anchor
   * to which location of the Tspan is related.
   * @type jsgl.HorizontalAnchor
   * @private
   */
  this.horizontalAnchor = jsgl.HorizontalAnchor.LEFT;
  ...
  /**
   * Vertical anchor of the Tspan. It specifies the Y-component of the anchor
   * to which location of the Tspan is related.
   * @type jsgl.VerticalAnchor
   * @private
   */
  ...
  /**
   * The DOM presenter that is used for rendering the Tspan on the user's browser.
   * @type jsgl.elements.AbstractDomPresenter
   * @private
   */
  this.domPresenter = domPresenter;
...
jsgl.elements.TspanElement.jsglExtend(jsgl.elements.AbstractElement);

/**
 * @description Gets the associated DOM presenter that is used for rendering
 * the Tspan.
 * @methodOf jsgl.elements.TspanElement#
 * @returns {jsgl.elements.AbstractDomPresenter}
 * @since version 1.0
 */
jsgl.elements.TspanElement.prototype.getDomPresenter = function() {

  return this.domPresenter;
}

/**
 * @description Gets the X-axis coordinate of the Tspan's anchor point.
 * @methodOf jsgl.elements.TspanElement#
 * @returns {number}
 * @since version 1.0
 */
jsgl.elements.TspanElement.prototype.getX = function() {

  return this.location.X;
}

/**
 * @description Sets the X-axis coordinate of the Tspan's anchor point.
 * @methodOf jsgl.elements.TspanElement#
 * @param {number} newX Real number representing the new X-coordinate of the
 * Tspan's anchor point.
 * @since version 1.0
 */
...
/**
 * @description Gets the Y-axis coordinate of the Tspan's anchor point.
 * @methodOf jsgl.elements.TspanElement#
 * @returns {number}
 * @since version 1.0
 */
jsgl.elements.TspanElement.prototype.getY = function() {

  return this.location.Y;
}

/**
 * @description Sets the Y-axis coordinate of the Tspan's anchor point.
 * @methodOf jsgl.elements.TspanElement#
 * @param {number} newY Real number representing the new Y-coordinate of the
 * Tspan's anchor point.
 * @since version 1.0
 */
jsgl.elements.TspanElement.prototype.setY = function(newY) {
...
/**
 * @description Gets the location of the Tspan's anchor point.
 * @methodOf jsgl.elements.TspanElement#
 * @returns {jsgl.Vector2D}
 * @since version 1.0
 */
jsgl.elements.TspanElement.prototype.getLocation = function() {

  return jsgl.cloneObject(this.location);
}

/**
 * @description Sets the location of the Tspan's anchor point using
 * <code>jsgl.Vector2D</code> object.
 * @methodOf jsgl.elements.TspanElement#
 * @param {jsgl.Vector2D} newLocation The new coordinates of the anchor point.
 * @since version 1.0
 */
jsgl.elements.TspanElement.prototype.setLocation = function(newLocation) {

  this.setLocationXY(newLocation.X, newLocation.Y);
}

/**
 * @description Sets the location of the Tspan's anchor point using couple
 * of real-valued coordinates (X and Y).
 * @methodOf jsgl.elements.TspanElement#
 * @param {number} newX Real number representing the new X-coordinate of the
 * Tspan's anchor point.
 ...
 * @since version 1.0
 */
jsgl.elements.TspanElement.prototype.setLocationXY = function(newX, newY) {
...
/**
 * @description Gets the current horizontal anchor of the Tspan.
 * @methodOf jsgl.elements.TspanElement#
 * @returns {jsgl.HorizontalAnchor}
 * @since version 1.0
 */
jsgl.elements.TspanElement.prototype.getHorizontalAnchor = function() {

  return this.horizontalAnchor;
}

/**
 * @description Sets the horizontal anchor of the Tspan. This allows the Tspan
 * to be aligned left, center, or right to its anchor point.
 * @methodOf jsgl.elements.TspanElement#
 * @param {jsgl.HorizontalAnchor} horizontalAnchor The new horizontal anchor
 * of the Tspan.
 * @since version 1.0
 */
jsgl.elements.TspanElement.prototype.setHorizontalAnchor = function(horizontalAnchor) {
...
/**
 * @description Gets the current vertical anchor of the Tspan.
 * @methodOf jsgl.elements.TspanElement#
 * @returns {jsgl.VerticalAnchor}
 * @since version 1.0
 */
jsgl.elements.TspanElement.prototype.getVerticalAnchor = function() {

  return this.verticalAnchor;
}

/**
 * @description Sets the vertical anchor of the Tspan. This allows the Tspan
 * to be aligned top, middle, or bottom to its anchor point.
 * @methodOf jsgl.elements.TspanElement#
 * @param {jsgl.VerticalAnchor} verticalAnchor the new vertical anchor of the
 * Tspan.
 * @since version 1.0
 */
jsgl.elements.TspanElement.prototype.setVerticalAnchor = function(verticalAnchor) {
...
/**
 * @description Gets the string currently displayed by the Tspan.
 * @methodOf jsgl.elements.TspanElement#
 * @returns {string}
 * @since version 1.0
 */
jsgl.elements.TspanElement.prototype.getText = function() {

  return this.text;
}

/**
 * @description Sets the new string to be displayed by the Tspan.
 * @methodOf jsgl.elements.TspanElement#
 * @param {string} newText The new string to be displayed.
 * @since version 1.0
 */
jsgl.elements.TspanElement.prototype.setText = function(newText) {
...
/**
 * @description Gets the current CSS font-family string for the Tspan.
 * @methodOf jsgl.elements.TspanElement#
 * @returns {string}
 * @since version 1.0
 */
jsgl.elements.TspanElement.prototype.getFontFamily = function() {

  return this.fontFamily;
}

/**
 * @description Sets the new CSS font-family string for the Tspan.
 * @methodOf jsgl.elements.TspanElement#
 * @param {string} fontFamily The new CSS font-family.
 * @since version 1.0
 */
jsgl.elements.TspanElement.prototype.setFontFamily = function(fontFamily) {
...
/**
 * @description Gets the current font size of the Tspan in pixels.
 * @methodOf jsgl.elements.TspanElement#
 * @returns {number}
 * @since version 1.0
 */
jsgl.elements.TspanElement.prototype.getFontSize = function() {

  return this.fontSize;
}

/**
 * @description Sets the new font size of the Tspan in pixels.
 * @methodOf jsgl.elements.TspanElement#
 * @param {number} fontSize Real number representing the new font size of the
 * Tspan in pixels.
 * @since version 1.0
 */
jsgl.elements.TspanElement.prototype.setFontSize = function(fontSize) {
...
/**
 * @description Gets the current CSS color of the Tspan's font.
 * @methodOf jsgl.elements.TspanElement#
 * @returns {string}
 * @since version 1.0
 */
jsgl.elements.TspanElement.prototype.getFontColor = function() {

  return this.fontColor;
}

/**
 * @description Sets the new color of the Tspan's font in the CSS color format.
 * @methodOf jsgl.elements.TspanElement#
 * @param {string} fontColor The new font color for the Tspan's font to be used.
 * @since version 1.0
 */
jsgl.elements.TspanElement.prototype.setFontColor = function(fontColor) {
...
/**
 * @description Determines whether or not the Tspan is currently underlined.
 * @methodOf jsgl.elements.TspanElement#
 * @returns boolean
 * @since version 1.0
 */
jsgl.elements.TspanElement.prototype.getUnderlined = function() {

  return this.underlined;
}

jsgl.elements.TspanElement.prototype.isUnderlined = jsgl.elements.TspanElement.prototype.getUnderlined;

/**
 * @description Sets whether or not the Tspan should be underlined.
 * @methodOf jsgl.elements.TspanElement#
 * @param {boolean} underlined Boolean value that turns the underlining
 * on or off.
 * @since version 1.0
 */
jsgl.elements.TspanElement.prototype.setUnderlined = function(underlined) {
...
/**
 * @description Determines whether the Tspan is currently overlined or not.
 * @methodOf jsgl.elements.TspanElement#
 * @returns {boolean}
 * @since version 1.0
 */
jsgl.elements.TspanElement.prototype.getOverlined = function() {

  return this.overlined;
}

jsgl.elements.TspanElement.prototype.isOverlined = jsgl.elements.TspanElement.prototype.getOverlined;

/**
 * @description Sets whether or not the Tspan should be overlined or not. Setting
 * overlining true causes the Tspan to have line above it.
 * @methodOf jsgl.elements.TspanElement#
 * @param {boolean} overlined Boolean value that turns the overlining
 * on or off.
 * @since version 1.0
 */
jsgl.elements.TspanElement.prototype.setOverlined = function(overlined) {
...
/**
 * @description Determines whether the Tspan is currently struck-through or not.
 * @methodOf jsgl.elements.TspanElement#
 * @returns {boolean}
 * @since version 1.0
 */
jsgl.elements.TspanElement.prototype.getStruckThrough = function() {

  return this.struckThrough;
}

jsgl.elements.TspanElement.prototype.isStruckThrough = jsgl.elements.TspanElement.prototype.getStruckThrough;

/**
 * @description Sets whether or not the Tspan should be struck-through or not.
 * Setting this true causes the Tspan to have line that crosses it.
 * @methodOf jsgl.elements.TspanElement#
 * @param {boolean} struckThrough Boolean value that turns the strikethrough
 * on or off.
 * @since version 1.0
 */
jsgl.elements.TspanElement.prototype.setStruckThrough = function(struckThrough) {
...
/**
 * @description Determines whether the font weight of the Tspan is currently bold.
 * @methodOf jsgl.elements.TspanElement#
 * @returns {boolean}
 * @since version 1.0
 */
jsgl.elements.TspanElement.prototype.getBold=function() {

  return this.bold;
}

jsgl.elements.TspanElement.prototype.isBold = jsgl.elements.TspanElement.prototype.getBold();

/**
 * @description Sets whether or not the font weight of the Tspan should be bold.
 * @methodOf jsgl.elements.TspanElement#
 * @param {boolean} bold Boolean value telling whether or not use bold font.
 * @since version 1.0
 */
jsgl.elements.TspanElement.prototype.setBold = function(bold) {
...
/**
 * @description Determines whether the font style of the Tspan is currently
 * italics.
 * @methodOf jsgl.elements.TspanElement#
 * @returns {boolean}
 * @since version 1.0
 */
jsgl.elements.TspanElement.prototype.getItalics = function() {
  return this.italics;
}

jsgl.elements.TspanElement.prototype.isItalics = jsgl.elements.TspanElement.getItalics;

/**
 * @description Sets whether or not the font style of the Tspan should be
 * italics.
 * @methodOf jsgl.elements.TspanElement#
 * @param {boolean} italics Boolean value telling whether or not use italics font.
 * @since version 1.0
 */
jsgl.elements.TspanElement.prototype.setItalics = function(italics) {
...
/**
 * @description Gets the current opacity of the Tspan.
 * @methodOf jsgl.elements.TspanElement#
 * @returns {number} The current opacity.
 * @since version 2.0
 */
jsgl.elements.TspanElement.prototype.getOpacity = function() {

  return this.opacity;
}

/**
 * @description Sets the opacity of the Tspan.
 * @methodOf jsgl.elements.TspanElement#
 * @param {number} opacity The new opacity.
 * @since version 2.0
 */
jsgl.elements.TspanElement.prototype.setOpacity = function(opacity) {
...
//#############################################################
/**
 * @fileOverview <code>jsgl.elements.SvgTspanDomPresenter</code> implementation.
 * @author Tomas Rehorek
 * @since version 2.0
 */

/**
 * @class Scalable Vector Graphics DOM presenter for JSGL Tspan element.
 * @extends jsgl.elements.AbstractDomPresenter
 * @constructor
 * @description Creates new instance of
 * <code>jsgl.elements.SvgTspanDomPresenter</code>
 * @param {XmlDocument} ownerDocument The factory XmlDocument to be used for
 * creating HTML elements.
 * @since version 2.0
 */
jsgl.elements.SvgTspanDomPresenter = function(ownerDocument) {
   ...
   * @private
   */
  this.SVGTspanElement = ownerDocument.createElementNS("http://www.w3.org/2000/svg","tspan");
  ...
  this.attachMouseHandlers(this.SVGTspanElement);

  // this.attachMouseHandlers(this.SVGTspanElement);

}
jsgl.elements.SvgTspanDomPresenter.jsglExtend(
    jsgl.elements.AbstractDomPresenter);

/**
 * @description Gets the SVG <code>&lt;text&gt;</code> element that is used
 * for rendering the Tspan.
 * @methodOf jsgl.elements.SvgTspanDomPresenter#
 * @private
 * @since version 2.0
 */
jsgl.elements.SvgTspanDomPresenter.prototype.getXmlElement = function() {

  return this.SVGTspanElement;
}

/**
 * @description Updates the contents of rendering SVG according to the state
 * of the JSGL Tspan element associated.
 * @methodOf jsgl.elements.SvgTspanDomPresenter#
 * @private
 * @since version 2.0
 */
jsgl.elements.SvgTspanDomPresenter.prototype.update = function() {

  jsgl.elements.AbstractDomPresenter.prototype.update.call(this);

  this.textNode.nodeValue = this.graphicsElement.getText();

  this.SVGTspanElement.style.setProperty('font-family', this.graphicsElement.getFontFamily(), null);
  this.SVGTspanElement.style.setProperty('fill', this.graphicsElement.getFontColor(), null);
  ...
  this.SVGTspanElement.style.fontSize = this.graphicsElement.getFontSize()+"px";
  this.SVGTspanElement.style.textDecoration = decorationString;
  this.SVGTspanElement.style.fontWeight = this.graphicsElement.getBold()?"bold":"normal";
  this.SVGTspanElement.style.fontStyle = this.graphicsElement.getItalics()?"italic":"normal";

  this.SVGTspanElement.style.opacity = this.graphicsElement.getOpacity();
  ...
  this.SVGTspanElement.setAttribute('x', this.graphicsElement.getX());
  ...
  this.SVGTspanElement.setAttribute('y', this.graphicsElement.getY());
...
/**
 * @fileOverview <code>jsgl.elements.NonSvgTspanDomPresenter</code> implementation.
 * @author Tomas Rehorek
 * @since version 2.0
 */

/**
 * @class Non-SVG, HTML-based DOM presenter for JSGL Tspan element.
 * @extends jsgl.elements.AbstractDomPresenter
 * @constructor
 * @description Creates new instance of <code>jsgl.elements.NonSvgTspanDomPresenter</code>.
 * @param {XmlDocument} ownerDocument The factory XmlDocument to be used for
 * creating HTML elements.
 * @since version 2.0
 */
jsgl.elements.NonSvgTspanDomPresenter=function(ownerDocument) {
...
jsgl.elements.NonSvgTspanDomPresenter.jsglExtend(
    jsgl.elements.AbstractDomPresenter);

/**
 * @description Gets the HTML <code>&lt;nobr&gt;</code> element that is used
 * to render the Tspan.
 * @methodOf jsgl.elements.NonSvgTspanDomPresenter#
 * @returns HTMLNobrElement
 * @since version 2.0
 */
jsgl.elements.NonSvgTspanDomPresenter.prototype.getXmlElement = function() {
...
/**
 * @description Updates the contents and CSS properties of the <code>&lt;nobr&gt;</code>
 * HTML element according to the state of the associated JSGL Tspan element.
 * @methodOf jsgl.elements.NonSvgTspanDomPresenter#
 * @since version 2.0
 */
jsgl.elements.NonSvgTspanDomPresenter.prototype.update=function() {
  ...
  /*
   * After all the properties affecting size of the Tspan (text, font size etc.)
   * are set, compute the X and Y offset according to vertical and horizontal
   * anchors using clientWidth and clientHeight.
   */
...
/**
 * @description Factory method that creates new instance of <code>TspanElement</code>.
 * @methodOf jsgl.Panel#
 * @returns {jsgl.elements.TspanElement}
 * @since version 1.0
 */
jsgl.Panel.prototype.createTspan=function(x,y,text,zIndex) {

  var domPresenter;

  if(jsgl.util.BrowserInfo.supportsSvg) {

    domPresenter = new jsgl.elements.SvgTspanDomPresenter(this.ownerDocument);
  }
  else {

    domPresenter = new jsgl.elements.NonSvgTspanDomPresenter(this.ownerDocument);
  }

  return new jsgl.elements.TspanElement(domPresenter,this,x,y,text,zIndex);
}
